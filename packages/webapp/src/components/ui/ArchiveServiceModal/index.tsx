...
interface ArchiveServiceModalProps extends ComponentProps {
	serviceName: string
	showModal: boolean
	onSubmit?: () => void
	onDismiss?: () => void
...
const ArchiveServiceModal = memo(function ArchiveServiceModal({
	serviceName,
	showModal,
	onSubmit,
	onDismiss
...
export default wrap(ArchiveServiceModal)
