 ...
 */
import { ServiceAnswer, ServiceAnswersInput } from '@cbosuite/schema/dist/provider-types'
...
export class GetServicesAnswersInteractor
	implements Interactor<ServiceAnswersInput, ServiceAnswer[]>
{
	public constructor(
	...
	public async execute({ serviceId, offset, limit }: ServiceAnswersInput, ctx: RequestContext) {
		offset = offset ?? 0
		limit = limit ?? 250
